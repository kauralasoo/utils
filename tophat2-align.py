...
parser.add_argument("--gtf", help = "GTF/GFF file for TopHat", 
	default = "/nfs/users/nfs_k/ka8/group-scratch/kaur/annotations/GRCh37/Ensembl_74/Homo_sapiens.GRCh37.74.gtf")
...
parser.add_argument("--queue", help = "Farm queue used for computation.", default = "normal")
